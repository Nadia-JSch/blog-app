...
> This article is AI generated by Codex, Claude, and Amp. I used them all to vibe code the app into existence as well. Visit the [That Tech Girl app](https://that-tech-girl-app.pages.dev/), whose current in-app experience is called **Soft Focus Code**.

# How That Tech Girl Actually Works: A Code Walkthrough

This post walks through a real React + Vite PWA called [That Tech Girl](https://that-tech-girl-app.pages.dev/). The current in-app experience is branded as **Soft Focus Code**: a daily ritual app for women in tech that mixes soft, over-the-top design with real technical learning.
...
![Soft Focus Code hero](/images/soft-focus-code-hero.png)
...
![Soft Focus Code overview](/images/soft-focus-code-overview.png)
